		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"border":"0px solid #ceddee","minHeight":"100px","padding":"10px 0px","boxShadow":"0 0px 0px 0px rgba(100,100,100,.05)","margin":"0px","overflow":"hidden","borderRadius":"20px 20px","flexWrap":"wrap","background":"none","display":"flex","fontSize":"inherit","justifyContent":"center"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"0px","boxShadow":"0 0px 0px 0px rgba(115,108,203,.23)","margin":"0 0px 0px 0","borderRadius":"0px","alignItems":"center","background":"none","display":"flex","width":"auto","fontSize":"inherit","justifyContent":"center","order":"2"}' >
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">咨询名称</label>
						<el-input v-model="searchForm.zixunmingcheng" placeholder="咨询名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"margin":"0 10px 0 0","fontSize":"inherit","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"inherit","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">咨询日期</label>
						<el-date-picker v-model="searchForm.zixunriqistart" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="咨询日期起始"></el-date-picker>
						至
						<el-date-picker v-model="searchForm.zixunriqiend" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="咨询日期结束"></el-date-picker>
					</div>
			...
			<div :style='{"padding":"0px","boxShadow":"inset 0px 0px 0px 0px #E8EFF6","borderColor":"#d2d0d0","margin":"0 0 0px","borderRadius":"0px","background":"rgba(255,255,255,.8)","borderWidth":"1px","width":"100%","borderStyle":"solid"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' v-if="isAuth('zixunxinxi','审核')" prop="sfsh" label="回复">
						<template slot-scope="scope">
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
           ...
           if(this.searchForm.zixunmingcheng!='' && this.searchForm.zixunmingcheng!=undefined){
            params['zixunmingcheng'] = '%' + this.searchForm.zixunmingcheng + '%'
          }
    params['sort'] = 'zixunriqi';
    params['order'] = 'desc';
           if(this.searchForm.zixunriqistart!='' && this.searchForm.zixunriqistart!=undefined ){
            params['zixunriqistart'] = this.searchForm.zixunriqistart
          }
          if(this.searchForm.zixunriqiend!='' && this.searchForm.zixunriqiend!=undefined){
            params['zixunriqiend'] = this.searchForm.zixunriqiend
          }
      this.$http({
        url: "zixunxinxi/page",
        method: "get",
